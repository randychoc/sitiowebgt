    ...
    <Navbar fixed="top" bg="light" variant="light" expand="md">
        ...
        <Navbar.Collapse id="basic-navbar-nav">
            <Nav className="mx-auto" >
                <NavDropdown.Divider />
                <Nav.Link className="paginas" href="../"> <Image src={InicioI} width="21" rounded /> Inicio</Nav.Link>
                <NavDropdown.Divider />
                <Nav.Link className="paginas" href="../Servicios"> <Image src={ServiciosI} width="25" rounded /> Servicios</Nav.Link>
                <NavDropdown.Divider />
                <Nav.Link className="paginas" href="../Catalogo"> <Image src={CatalogoI} width="22" rounded /> Catálogo</Nav.Link>
                <NavDropdown.Divider />
                <Nav.Link className="paginas" href="../Contactenos"> <Image src={ContactenosI} width="22" rounded /> Contáctenos</Nav.Link>
                <NavDropdown.Divider />
            </Nav>
            <Nav>
                <Nav.Link className="paginas"
                    href="https://api.whatsapp.com/send?phone=+50247707384&text=Hola%20SitioWebGt.com%20deseo%20contratar%20sus%20servicios."
                    target="_blank"
                    rel="noopener noreferrer">
                    <Image src={WhatsAppI} width="25" rounded /> +502 4770-7384</Nav.Link>
                <NavDropdown.Divider />
            </Nav>
        </Navbar.Collapse>
    </Navbar>
